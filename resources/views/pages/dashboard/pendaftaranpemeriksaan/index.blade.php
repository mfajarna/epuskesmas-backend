                ...
                <div class="col-xl-3 col-sm-6">
                    <div class="card text-center">
                        ...
                        <div class="btn-group" role="group">
                            <a href="{{ url('admin/pendaftaran-pemeriksaan/pendaftaran/'. $data->id . '/'. $data->poli->nama_poli) }}"class="btn btn-outline-primary text-truncate"><i class="uil uil-user me-1"></i>Pilih Poli</a>
                        </div>
                    </div>
                    <!-- end card -->
                </div>
