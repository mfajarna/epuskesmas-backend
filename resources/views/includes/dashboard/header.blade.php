        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="index.html" class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="{{ url('/public/assets/images/logo-sm.svg')}}" alt="" height="24">
                    </span>
                    <span class="logo-lg">
                        <img src="{{ url('/public/assets/images/logo-sm.svg')}}" alt="" height="24"> <span class="logo-txt">E-Puskesmas</span>
                    </span>
                </a>
